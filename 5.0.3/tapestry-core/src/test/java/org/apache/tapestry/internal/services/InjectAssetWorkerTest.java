...
public class InjectAssetWorkerTest extends InternalBaseTestCase
{
    ...
    public void asset_field_without_annotation()
    {
        ...
        new InjectAssetWorker(null, null).transform(ct, model);
    ...
    public void asset_field_with_full_annotation()
    {
        ...
        train_value(annotation, "${mysymbol}");

        train_expandSymbols(symbolSource, "${mysymbol}", "foo.gif");
        ...
        new InjectAssetWorker(source, symbolSource).transform(ct, model);
