...
public class SymbolSourceImplTest extends IOCInternalTestCase
{
    ...
    {
        SymbolProvider provider = newSymbolProvider();
    ...
    {
        SymbolProvider provider1 = newSymbolProvider();
        SymbolProvider provider2 = newSymbolProvider();
    ...
    protected final SymbolProvider newSymbolProvider()
    {
