...
/**
 * A wrapper around a named parameter provided by {@link org.apache.tapestry5.internal.InternalComponentResources}.
 *
 * @since 5.0.19
 */
public interface ParameterAccess extends AnnotationProvider
{
     ...
     *
     * @param desiredTypeName the name of the Java type to coerce the result to
