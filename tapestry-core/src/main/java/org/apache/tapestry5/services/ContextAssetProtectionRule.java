...
/**
 * Chain-of-responsibility service which defines rules for blocking access to context resources
 * based on their paths. Access is blocked if any rule says it should be blocked.
 *
 * @see ClasspathAssetProtectionRule
 * @since 5.10.0
 */
@UsesOrderedConfiguration(ContextAssetProtectionRule.class)
public interface ContextAssetProtectionRule
{
    /**
