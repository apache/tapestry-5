 ...
 * <ol>
 *     <li>
 *          During startup, based on on contributions to {@linkplain EsModuleManager}.
 ...
 *          global per-request ones contributed to {@linkplain EsModuleManager} are invoked
 *          in all requests.
 *     </li>
 * </ol>
 *
...
public interface EsModuleConfigurationCallback
{
    ...
    /**
     * Utility method to create a callback to set or override one module and its URL.
     * @param id the module id.
     * @param url the module URL.
